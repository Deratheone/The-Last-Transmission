...
3. In the participant terminal's Serial Monitor, enter `NOTDIS` and send it.
...
The response restores EVA's hidden cache and reveals **Room 7** plus the last recorded key, `TSMEMO`.
